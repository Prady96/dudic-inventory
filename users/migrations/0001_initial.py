    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('items', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.Items')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.ImageField(blank=True, default='/Users/prady/DUDIC_HD/DUDIC/dudic-inventory/inventory/static/admin/img/sample_image.svg', null=True, upload_to='inventory_thumbnails/')),
                ('item_status', models.CharField(choices=[('APP', 'Approved'), ('DEC', 'Declined'), ('HLD', 'OnHold')], default='HLD', max_length=3)),
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.Categorie')),
                ('issued_to', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.InventoryIssued')),
                ('item_name', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='users.Items')),
        ...
        migrations.AddField(
            ...
            name='item_name',
            field=models.ManyToManyField(through='users.Quantity', to='users.Items'),
        ),
        migrations.AddField(
            model_name='inventoryissued',
            name='user',
