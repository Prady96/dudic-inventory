# Generated by Django 2.2 on 2020-01-06 09:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('get_users', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='issued', to=settings.AUTH_USER_MODEL)),
                ('item_name', models.ManyToManyField(to='users.InventoryPresent')),
